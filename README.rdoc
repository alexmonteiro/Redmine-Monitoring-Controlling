...
* Mysql database - because some date functions may get error with another data bases.
...
* Railscasts[http://railscasts.com/]: learn how in #223[http://railscasts.com/episodes/223-charts] episode to use highcharts on your rails app.