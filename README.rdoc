...
===Master Version (0.0.3) (Redmine 1.4.x)
====Task Management
* Pie Chart of issues by statuses;
* Pie Chart of manageable and unmanagleabe issues;
* Chart with overdue tasks by project.
...
* Copie ou clone a o conteúdo do plugin para a pasta de plugins do Redmine: /vendor/plugins/redmine_monitoring_controlling .
