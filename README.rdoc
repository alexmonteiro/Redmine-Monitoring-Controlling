...
Redmine Monitoring & Controlling Plugin is open source and released under the terms of the "GNU General Public License v3"[https://github.com/alexmonteiro/Redmine-Monitoring-Controlling/blob/master/license.txt] (GPL).
